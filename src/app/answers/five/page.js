    ...
    <div className='container mx-auto h-full'>
        ...
        <div className="container mx-auto p-4 flex flex-col justify-center items-center">
            ...
            <p className='my-4 text-neutral-500'>
                A.  Hi there,<br /><br />
                Sorry to hear that this is causing frustration. I understand the desire to get this going as soon as possible. Unfortunatetly, I won't be able to change/fix this for you, but I would be happy to continue working with you on this!<br /><br />
